...
std::list<libcomp::Message::MessageType> AmalaManager::GetSupportedTypes() const
{
    return {
    ...
    const libcomp::Message::Packet *pMessage)
{
    ...
    {
        case to_underlying(ChannelToClientPacketCode_t::PACKET_AMALA_ACCOUNT_DUMP_HEADER):
            return HandlePacketChannelAmalaAccountDumpHeader(p);
        case to_underlying(ChannelToClientPacketCode_t::PACKET_AMALA_ACCOUNT_DUMP_PART):
...
bool AmalaManager::HandlePacketChannelAmalaAccountDumpHeader(libcomp::ReadOnlyPacket &p)
{
...
bool AmalaManager::HandlePacketChannelAmalaAccountDumpPart(libcomp::ReadOnlyPacket &p)
{
    ...
    if(mAccountDumpPartCount == obj->GetPartNumber())
    {
            ...
            libcomp::Crypto::SHA1(mAccountDump) == mAccountDumpSHA1)
        {
            ...
            out.write(&mAccountDump[0],
                (std::streamsize)mAccountDump.size());
