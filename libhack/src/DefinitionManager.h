/**
 * @file libhack/src/DefinitionManager.h
 * @ingroup libhack
 *
 * @author HACKfrost
 *
...
#ifndef LIBHACK_SRC_DEFINITIONMANAGER_H
#define LIBHACK_SRC_DEFINITIONMANAGER_H
...
class DefinitionManager {
 public:
   ...
   */
  bool LoadAllData(libcomp::DataStore* pDataStore);
 ...
 protected:
   ...
   */
  template <class T>
  bool LoadBinaryData(libcomp::DataStore* pDataStore,
...
#endif  // LIBHACK_SRC_DEFINITIONMANAGER_H
