/**
 * @file libhack/src/MessageWorldNotification.h
 * @ingroup libhack
 *
...
#ifndef LIBHACK_SRC_MESSAGEWORLDNOTIFICATION_H
#define LIBHACK_SRC_MESSAGEWORLDNOTIFICATION_H
...
#endif  // LIBHACK_SRC_MESSAGEWORLDNOTIFICATION_H
