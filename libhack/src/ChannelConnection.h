/**
 * @file libhack/src/ChannelConnection.h
 * @ingroup libhack
 *
...
#ifndef LIBHACK_SRC_CHANNELCONNECTION_H
#define LIBHACK_SRC_CHANNELCONNECTION_H
...
class ChannelConnection : public libcomp::EncryptedConnection {
 ...
 protected:
  virtual void PreparePackets(std::list<libcomp::ReadOnlyPacket>& packets);
...
#endif  // LIBHACK_SRC_CHANNELCONNECTION_H
