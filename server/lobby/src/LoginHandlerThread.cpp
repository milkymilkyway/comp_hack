...
ScriptEngine& ScriptEngine::Using<objects::LoginScriptRequest>() {
  if (!BindingExists("LoginScriptRequest")) {
    ...
    op.Const("OPERATION_GET",
             to_underlying(objects::LoginScriptRequest::OperationType_t::GET));
    op.Const(
        "OPERATION_LOGIN",
        to_underlying(objects::LoginScriptRequest::OperationType_t::LOGIN));
    op.Const("OPERATION_QUIT",
             to_underlying(objects::LoginScriptRequest::OperationType_t::QUIT));
    ...
    binding
        ...
        .Prop("clientVersion", &objects::LoginScriptRequest::GetClientVersion,
        ...
        .Func("postVarExists", &objects::LoginScriptRequest::PostVarsKeyExists)
        .Func<libcomp::String (objects::LoginScriptRequest::*)(
            const libcomp::String&)>("postVar",
                                     &objects::LoginScriptRequest::GetPostVars)
        .Func("postVarCount", &objects::LoginScriptRequest::PostVarsCount)
        .Func<bool (objects::LoginScriptRequest::*)(const libcomp::String&,
                                                    const libcomp::String&)>(
            "postVarSet", &objects::LoginScriptRequest::SetPostVars)
        .Func("postVarRemove",
              &objects::LoginScriptRequest::RemovePostVars);  // Last call to
                                                              // binding
...
ScriptEngine& ScriptEngine::Using<objects::LoginScriptReply>() {
  if (!BindingExists("LoginScriptReply")) {
    ...
    binding
        ...
        .Prop("clientVersion", &objects::LoginScriptReply::GetClientVersion,
        ...
        .Func("replaceVarCount", &objects::LoginScriptReply::ReplaceVarsCount)
        .Func<bool (objects::LoginScriptReply::*)(const libcomp::String&,
                                                  const libcomp::String&)>(
            "replaceVarSet", &objects::LoginScriptReply::SetReplaceVars)
        .Func("replaceVarRemove", &objects::LoginScriptReply::RemoveReplaceVars)
        ...
        .Prop("sid2", &objects::LoginScriptReply::GetSID2,
              &objects::LoginScriptReply::SetSID2);  // Last call to binding
...
bool LoginHandlerThread::DidInit() const { return mDidInit; }
...
bool LoginHandlerThread::ProcessLoginRequest(
    const std::shared_ptr<objects::LoginScriptRequest>& req) {
  req->SetOperation(
      to_underlying(objects::LoginScriptRequest::OperationType_t::ERROR));

  auto ref = Sqrat::RootTable(mEngine.GetVM())
                 .GetFunction("ProcessLoginRequest")
                 .Evaluate<bool>(req);
...
bool LoginHandlerThread::ProcessLoginReply(
    const std::shared_ptr<objects::LoginScriptReply>& reply) {
  auto ref = Sqrat::RootTable(mEngine.GetVM())
                 .GetFunction("ProcessLoginReply")
                 .Evaluate<bool>(reply);
