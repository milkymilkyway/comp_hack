...
class ChannelServer : public libcomp::BaseServer {
 public:
   ...
   * @param config Pointer to a casted ChannelConfig that will contain
   * properties every server has in addition to channel specific ones.
   */
 ...
 protected:
  ...
  std::map<ServerTime, std::list<libcomp::Message::Execute*>> mScheduledWork;
