...
uint8_t FUSION_RACE_MAP[35][34] = {
    // Idx Map
    {(uint8_t)RaceID::SERAPHIM,      (uint8_t)RaceID::ENTITY,
     (uint8_t)RaceID::DEMON_GOD,     (uint8_t)RaceID::VILE,
     (uint8_t)RaceID::AVIAN,         (uint8_t)RaceID::GODDESS,
     (uint8_t)RaceID::HEAVENLY_GOD,  (uint8_t)RaceID::RAPTOR,
     (uint8_t)RaceID::DIVINE,        (uint8_t)RaceID::EVIL_DEMON,
     (uint8_t)RaceID::WILD_BIRD,     (uint8_t)RaceID::YOMA,
     (uint8_t)RaceID::EARTH_ELEMENT, (uint8_t)RaceID::REAPER,
     (uint8_t)RaceID::HOLY_BEAST,    (uint8_t)RaceID::BEAST,
     (uint8_t)RaceID::FAIRY,         (uint8_t)RaceID::DEMIGOD,
     (uint8_t)RaceID::WILDER,        (uint8_t)RaceID::DRAGON_KING,
     (uint8_t)RaceID::NOCTURNE,      (uint8_t)RaceID::GODLY_BEAST,
     (uint8_t)RaceID::FOUL,          (uint8_t)RaceID::BRUTE,
     (uint8_t)RaceID::HAUNT,         (uint8_t)RaceID::DRAGON,
     (uint8_t)RaceID::FALLEN_ANGEL,  (uint8_t)RaceID::FEMME,
     (uint8_t)RaceID::NATION_RULER,  (uint8_t)RaceID::EARTH_MOTHER,
     (uint8_t)RaceID::EVIL_DRAGON,   (uint8_t)RaceID::GUARDIAN,
     (uint8_t)RaceID::DESTROYER,     (uint8_t)RaceID::TYRANT},
    // 大天使: SERAPHIM
    {
        0,                              // x SERAPHIM
...
uint8_t FUSION_FAMILIARITY_BONUS[5][5] = {{1, 0, 0, 1, 3},
                                          {21, 0, 1, 2, 4},
                                          {51, 0, 1, 2, 5},
                                          {71, 1, 1, 3, 6},
                                          {91, 1, 1, 3, 7}};
...
uint8_t TRIFUSION_RACE_PRIORITY[34] = {
    (uint8_t)RaceID::SERAPHIM,      (uint8_t)RaceID::HEAVENLY_GOD,
    (uint8_t)RaceID::AVIAN,         (uint8_t)RaceID::GODDESS,
    (uint8_t)RaceID::DEMON_GOD,     (uint8_t)RaceID::GODLY_BEAST,
    (uint8_t)RaceID::HOLY_BEAST,    (uint8_t)RaceID::VILE,
    (uint8_t)RaceID::ELEMENTAL,     (uint8_t)RaceID::DESTROYER,
    (uint8_t)RaceID::DRAGON,        (uint8_t)RaceID::EARTH_MOTHER,
    (uint8_t)RaceID::NATION_RULER,  (uint8_t)RaceID::GUARDIAN,
    (uint8_t)RaceID::DEMIGOD,       (uint8_t)RaceID::TYRANT,
    (uint8_t)RaceID::DIVINE,        (uint8_t)RaceID::REAPER,
    (uint8_t)RaceID::RAPTOR,        (uint8_t)RaceID::WILD_BIRD,
    (uint8_t)RaceID::DRAGON_KING,   (uint8_t)RaceID::YOMA,
    (uint8_t)RaceID::BEAST,         (uint8_t)RaceID::NOCTURNE,
    (uint8_t)RaceID::EARTH_ELEMENT, (uint8_t)RaceID::FAIRY,
    (uint8_t)RaceID::EVIL_DEMON,    (uint8_t)RaceID::FALLEN_ANGEL,
    (uint8_t)RaceID::EVIL_DRAGON,   (uint8_t)RaceID::WILDER,
    (uint8_t)RaceID::BRUTE,         (uint8_t)RaceID::FEMME,
    (uint8_t)RaceID::HAUNT,         (uint8_t)RaceID::FOUL};
...
uint8_t INHERITENCE_SKILL_MAP[21][21] = {
    {100, 63, 63, 63, 63, 63, 21, 21, 21,  21, 21,
     21,  21, 21, 21, 21, 21, 21, 21, 100, 15},  // SLASH
    {63, 100, 63, 63, 63, 63, 21, 21, 21,  21, 21,
     21, 21,  21, 21, 21, 21, 21, 21, 100, 15},  // THRUST
    {63, 63, 100, 63, 63, 63, 21, 21, 21,  21, 21,
     21, 21, 21,  21, 21, 21, 21, 21, 100, 15},  // STRIKE
    {63, 63, 63, 100, 63, 63, 21, 21, 21,  21, 21,
     21, 21, 21, 21,  21, 21, 21, 21, 100, 15},  // LNGR
    {63, 63, 63, 63, 100, 63, 21, 21, 21,  21, 21,
     21, 21, 21, 21, 21,  21, 21, 21, 100, 15},  // PIERCE
    {63, 63, 63, 63, 63, 100, 21, 21, 21,  21, 21,
     21, 21, 21, 21, 21, 21,  21, 21, 100, 15},  // SPREAD
    {31, 31, 31, 31, 31, 31, 100, 15, 45, 45, 45,
     45, 45, 31, 31, 31, 31, 31,  31, 21, 100},  // FIRE
    {31, 31, 31, 31, 31, 31, 15, 100, 45, 45, 45,
     45, 45, 31, 31, 31, 31, 31, 31,  21, 100},  // ICE
    {31, 31, 31, 31, 31, 31, 63, 63, 100, 45, 45,
     45, 45, 31, 31, 31, 31, 31, 31, 21,  100},  // ELEC
    {15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15,
     15, 15, 15, 15, 15, 15, 15, 15, 15, 15},  // ALMIGHTY
    {31, 31, 31, 31, 31, 31, 63, 63, 45, 100, 45,
     45, 45, 31, 31, 31, 31, 31, 31, 21, 100},  // FORCE
    {31, 31, 31, 31, 31, 31, 45, 45, 45, 45, 100,
     15, 45, 31, 31, 31, 31, 31, 31, 31, 85},  // EXPEL
    {31,  31, 31, 31, 31, 31, 45, 45, 45, 45, 15,
     100, 15, 31, 31, 31, 31, 31, 31, 31, 85},  // CURSE
    {15, 15,  15, 15, 15, 15, 31, 31, 31, 31, 63,
     15, 100, 85, 31, 31, 31, 31, 31, 21, 31},  // HEAL
    {63, 63, 63,  63, 63, 63, 63, 63, 63, 63, 63,
     63, 85, 100, 63, 63, 63, 63, 63, 63, 63},  // SUPPORT
    {21, 21, 21, 21,  21, 21, 31, 31, 31, 31, 31,
     31, 31, 31, 100, 63, 63, 63, 63, 21, 63},  // MAGICFORCE
    {21, 21, 21, 21, 21,  21, 31, 31, 31, 31, 31,
     31, 31, 31, 63, 100, 63, 63, 63, 21, 63},  // NERVE
    {21, 21, 21, 21, 21, 21,  31, 31, 31, 31, 31,
     31, 31, 31, 63, 63, 100, 63, 63, 21, 63},  // MIND
    {21, 21, 21, 21, 21, 21, 31,  31, 31, 31, 31,
     31, 31, 31, 63, 63, 63, 100, 63, 21, 63},  // WORD
    {63, 63, 63, 63, 63, 63, 63, 63,  63, 63, 63,
     63, 63, 63, 63, 63, 63, 63, 100, 63, 63},  // SPECIAL
    {15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15,
     15, 15, 15, 15, 15, 15, 15, 15, 15, 15}  // SUICIDE
};
