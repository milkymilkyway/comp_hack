...
class AccountManager {
 public:
   ...
   */
  bool IsLoggedIn(const libcomp::String& username, int8_t& channel);
   ...
   */
  bool ExpireSession(const libcomp::String& username, uint32_t key);
   ...
   */
  std::list<std::shared_ptr<objects::AccountLogin>> LogoutUsersOnChannel(
      int8_t channel);
   ...
   */
  bool ChannelSwitchPending(const libcomp::String& username, int8_t& channel);
   ...
   */
  bool EndWebGameSession(const libcomp::String& username, bool notifyLobby,
                         bool notifyChannel);
 ...
 private:
  ...
  std::unordered_map<libcomp::String, std::shared_ptr<objects::ChannelLogin>>
      mChannelSwitches;
